...
(function() {
  ...
  module.exports = {
    ...
    scanForWiFi: function () {
      var KEY, VALUE, _network, c, error, i, j, k, len, len1, ln, networks, nmcli_format, nwk, parsedLine, ref, ref1, scanResults, version_string, version_strings;
      version_string = this.execSync("nmcli --version");
      ...
      scanResults = this.execSync("nmcli -f" + nmcli_format + `-m multiline dev wifi list ifname ${this.WiFiControlSettings.iface}`);
      networks = [];
